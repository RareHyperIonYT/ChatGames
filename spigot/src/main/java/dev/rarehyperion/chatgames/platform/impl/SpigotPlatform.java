...
public class SpigotPlatform implements Platform {
    ...
    public void registerCommands(final ChatGamesCore core) {
        final PluginCommand command = this.plugin.getCommand("chatgames");
        if (command != null) {
            final SpigotChatGamesCommand executor = new SpigotChatGamesCommand(core);
    ...
    public void registerListeners(final ChatGamesCore core) {
        this.plugin.getServer().getPluginManager().registerEvents(new SpigotChatListener(core.gameManager()), this.plugin);
    }
